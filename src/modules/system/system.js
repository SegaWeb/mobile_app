...
function system_404_page(path) {
  return t('Sorry, the page you requested was not foundsssss.');
}
 ...
 * @return {Object}
 */
function system_dashboard_page1() {
  try {
    var content = {};
    content.site_info = {
      markup: '<h4 class="ssss" style="text-align: center;">' +
